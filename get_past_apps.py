...
query_all_result['title'], query_all_result['description'], query_all_result['recipient'] = zip(*query_all_result['metadata'].apply(extract_info))

query_all_result['recipient'] = query_all_result['recipient'].str.lower()

# Write the updated DataFrame to a CSV file
query_all_result.to_csv('./data/apps_18_to_20.csv', index=False)